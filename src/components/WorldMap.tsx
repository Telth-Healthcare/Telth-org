...
const offices = [
  ...
  // },
  {
    ...
    email: 'info@telth.org',
    coordinates: [28.6328027, 77.2197713] as [number, number],
  },
  {
    id: 5,
    country: ' India',
    ...
    address: 'Tidel Neo, Karuppur, Salem, Tamil Nadu',
    coordinates: [11.6551982, 78.1581771] as [number, number],
  },
  // {
  //   id: 6,
  //   country: '🇱🇨 St. Lucia',
  ...
  // },
  {
    ...
    email: 'info@telth.org',
    coordinates: [31.2323437, 121.4691024] as [number, number],
  ...
  },
  {
    ...
    email: 'info@telth.org',
    coordinates: [25.2296341, 55.2895850] as [number, number],
